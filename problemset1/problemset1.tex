...
Please submit your responses electronically by email to cta200@cita.utoronto.ca. Include as attachments your working (and commented) code -- make sure the instructors will be able to run your code.  Also include any figures you make as part of the activity.
